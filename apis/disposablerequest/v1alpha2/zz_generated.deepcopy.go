...
func (in *AuthenticationRequestParameters) DeepCopyInto(out *AuthenticationRequestParameters) {
	*out = *in
	if in.Headers != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AuthenticationRequestParameters.
func (in *AuthenticationRequestParameters) DeepCopy() *AuthenticationRequestParameters {
	if in == nil {
		return nil
	}
	out := new(AuthenticationRequestParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DisposableRequestParameters) DeepCopyInto(out *DisposableRequestParameters) {
	*out = *in
	if in.AuthenticationRequest != nil {
		in, out := &in.AuthenticationRequest, &out.AuthenticationRequest
		*out = new(AuthenticationRequestParameters)
		(*in).DeepCopyInto(*out)
	}
	if in.Headers != nil {
...
func (in *DisposableRequestStatus) DeepCopyInto(out *DisposableRequestStatus) {
	*out = *in
	...
	in.AuthenticationResponse.DeepCopyInto(&out.AuthenticationResponse)
	in.RequestDetails.DeepCopyInto(&out.RequestDetails)
	in.AuthenticationRequestDetails.DeepCopyInto(&out.AuthenticationRequestDetails)
